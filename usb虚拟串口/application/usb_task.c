...
send_packet_t send_packet={1,2,3,6};

static void set_send_packet(send_packet_t* send_packet)
{
    send_packet->header = 0123;
    send_packet->lxy = 031;
    send_packet->lxy265 = 236;
    send_packet->lxy715 = 63;
